...
$pedido->detalles; // Detalles del pedido
$detalle = App\Models\PedidoDetalle::first();
$detalle->producto; // Producto relacionado

// Verificar unique(sucursal_id, semana_inicio)
App\Models\Pedido::create([
	...
	'estado' => 'BORRADOR',
	'aud_usuario' => 'tinker',
]); // Lanzará error por duplicado

// Verificar unique(pedido_id, producto_id)
$pedido->detalles()->create([
	'producto_id' => 1,
	'cantidad' => 2,
	'precio_unitario' => 1.25,
