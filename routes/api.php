...
use App\Http\Controllers\Api\Operaciones\MermaBarrilController;
...
Route::prefix('compras')->middleware('auth:sanctum')->group(function () {
    ...
    Route::get('recetas/reporte-extras',               [RecetasController::class, 'reporteExtras']);
    ...
    Route::get('inventario/auditoria-conteo/fechas',                     [AuditoriaConteoController::class, 'fechas']);
    ...
    Route::post('inventario/auditoria-conteo/enviar-justificaciones',      [AuditoriaConteoController::class, 'enviarJustificaciones']);
...
Route::prefix('rrhh')->middleware(['auth:sanctum', 'role:jefatura,portal_admin,rrhh_admin,empleado,gerencia_ops,rrhh_analista,rrhh_analista_jr', 'view-as'])->group(function () {
    ...
    Route::get('horarios/empleado/{empleadoId}',  [HorariosController::class, 'empleadoSemana']);
