...
class BrewLoteCoccion extends Model
{
    ...
    protected $fillable = ['brew_lote_id', 'numero', 'vol_preboil_obj', 'vol_postboil_obj', 'og_real', 'vol_preboil_real', 'vol_postboil_real', 'temp_mash_real', 'tiempo_boil_min', 'notas',
