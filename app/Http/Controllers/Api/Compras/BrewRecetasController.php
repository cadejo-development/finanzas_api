...
class BrewRecetasController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'vol_preboil'         => 'nullable|numeric|min:0|max:99999.99',
            'vol_postboil'        => 'nullable|numeric|min:0|max:99999.99',
            'vol_bbt'             => 'nullable|numeric|min:0|max:99999.99',
            'og'                  => 'nullable|numeric|min:0|max:999.99',
            'fg'                  => 'nullable|numeric|min:0|max:999.99',
            'abv'                 => 'nullable|numeric|min:0|max:100',
            'ibu'                 => 'nullable|numeric|min:0|max:9999.99',
            'srm'                 => 'nullable|numeric|min:0|max:9999.99',
            'eficiencia_macerado' => 'nullable|numeric|min:0|max:100',
            ...
            'activa'              => 'boolean',
            'maltas'                         => 'array',
            'maltas.*.nombre'                => 'nullable|string|max:200',
            'maltas.*.cantidad_lb'           => 'nullable|numeric|min:0|max:99999.999',
            'maltas.*.molida_1_kg'           => 'nullable|numeric|min:0|max:99999.999',
            'maltas.*.molida_2_kg'           => 'nullable|numeric|min:0|max:99999.999',
            'maltas.*.proveedor'             => 'nullable|string|max:200',
            'maltas.*.brew_ingrediente_id'   => 'nullable|integer',
            'lupulos'                        => 'array',
            'lupulos.*.nombre'               => 'nullable|string|max:200',
            'lupulos.*.cantidad_g'           => 'nullable|numeric|min:0|max:99999.99',
            'lupulos.*.alpha'                => 'nullable|numeric|min:0|max:100',
            'lupulos.*.uso'                  => 'nullable|string|max:50',
            'lupulos.*.tiempo_min'           => 'nullable|integer|min:0',
            'lupulos.*.ibu_aporte'           => 'nullable|numeric|min:0|max:9999.99',
            'lupulos.*.brew_ingrediente_id'  => 'nullable|integer',
            'minerales'                         => 'array',
            'minerales.*.nombre'                => 'nullable|string|max:200',
            'minerales.*.cantidad_g'            => 'nullable|numeric|min:0|max:99999.999',
            'minerales.*.cantidad_sparge_g'     => 'nullable|numeric|min:0|max:99999.999',
            'minerales.*.fase'                  => 'nullable|string|max:50',
            'minerales.*.brew_ingrediente_id'   => 'nullable|integer',
            'levaduras'           => 'array',
