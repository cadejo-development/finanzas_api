...
<head>
  ...
  <title>Auditoría de Conteo Mensual</title>
</head>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.12);">
        ...
        <tr>
          <td style="background:#065f46;padding:14px 48px;text-align:center;">
            <p style="margin:0;color:#ffffff;font-size:14px;font-weight:600;letter-spacing:1px;text-transform:uppercase;">Auditoría de Conteo Mensual Completada</p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:32px 40px 16px;">
            <p style="margin:0 0 12px;color:#333333;font-size:15px;line-height:1.65;">
              Se ha completado la <strong>auditoría del conteo mensual</strong> para <strong>{{ $sucursalNombre }}</strong> correspondiente al <strong>{{ $fecha }}</strong>.
              Puedes revisar los resultados en el sistema y registrar tu decisión (aprobar o rechazar).
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:0 40px 16px;">
            <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e5e7eb;border-radius:8px;overflow:hidden;">
              ...
              <tr style="background:#fafafa;">
                <td style="padding:12px 18px;font-size:13px;color:#6b7280;border-bottom:1px solid #f3f4f6;">Auditor</td>
                <td style="padding:12px 18px;font-size:13px;font-weight:600;text-align:right;color:#111827;border-bottom:1px solid #f3f4f6;">{{ $auditorNombre }}</td>
              </tr>
              <tr style="background:#ffffff;">
                <td style="padding:12px 18px;font-size:13px;color:#6b7280;">Productos comprobados</td>
                <td style="padding:12px 18px;font-size:13px;font-weight:700;text-align:right;color:#059669;">{{ $totalComprobados }}</td>
              </tr>
            </table>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:0 40px 24px;">
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td style="background:#f0fdf4;border-left:4px solid #059669;border-radius:4px;padding:14px 18px;">
                  <p style="margin:0 0 4px;color:#065f46;font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:0.5px;">Declaración del auditor</p>
                  <p style="margin:0;color:#065f46;font-size:13px;line-height:1.6;font-style:italic;">"{{ $firma }}"</p>
                </td>
              </tr>
            </table>
          </td>
            ...
            <table cellpadding="0" cellspacing="0" align="center">
              <tr>
                <td style="background:#059669;border-radius:8px;padding:12px 32px;">
                  <a href="https://gestion-operaciones.cervezacadejo.com/inventario" style="color:#ffffff;font-size:14px;font-weight:700;text-decoration:none;display:inline-block;letter-spacing:0.3px;">Ver resultados en el sistema</a>
                </td>
              </tr>
            </table>
          </td>
