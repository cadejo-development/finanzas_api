...
<table width="100%" cellpadding="0" cellspacing="0" style="background:#f5f0e8;padding:32px 16px;">
  <tr><td align="center">
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width:580px;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.10);">
      ...
      {{-- Banner --}}
      <tr>
        <td style="background:#1d4ed8;padding:14px 48px;text-align:center;">
        ...
        <td style="padding:10px 40px 10px;">
          <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e5e7eb;border-radius:8px;overflow:hidden;margin-bottom:8px;">
            ...
            <tr>
              ...
              <td style="padding:12px 18px;border-bottom:1px solid #f3f4f6;color:#111827;font-size:13px;font-weight:600;text-align:right;background:{{ $loop->odd ? '#fafafa' : '#ffffff' }};">{{ $valor }}</td>
            </tr>
            @endforeach
          </table>
        </td>
      ...
      <tr>
        <td style="padding:8px 40px 24px;">
          <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
              <td style="background:#eff6ff;border-left:4px solid #3b82f6;border-radius:4px;padding:14px 18px;">
                <p style="margin:0;color:#1e40af;font-size:13px;line-height:1.6;">Este es un correo informativo. No se requiere ninguna accion de tu parte.</p>
              </td>
            </tr>
          </table>
        </td>
